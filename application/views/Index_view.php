...
<head>
    ...
    <!-- Stylesheets -->
        ...
        <script>
            // Make base_url available for client JS (used by rating scripts)
                            ...
                            <?php foreach ($dulieuPhimDCcon as $key => $value): ?>
                                ...
                                <div class="movie__info">
                                    ...
                                    <div class="movie__rate">
                                        <div class="score" data-movie-id="<?php echo $value['id']; ?>" data-current-rating="<?php echo isset($value['avg_rating']) ? $value['avg_rating'] : 0; ?>" data-readonly="1"></div>
                                        <span class="movie__rating"><?php echo isset($value['avg_rating']) ? number_format($value['avg_rating'],1) : '0.0'; ?></span>
                                    </div>               
                                </div>
                            </div>
                            <?php endforeach ?>
