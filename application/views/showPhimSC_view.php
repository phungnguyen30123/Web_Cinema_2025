                    ...
                    <div class="col-sm-9 col-md-10 col-lg-10 movie__about">
                            ...
                            <div class="preview-footer">
                                <div class="movie__rate">
                                    <div class="score"></div>
                                    <span class="movie__rate-number"><?php echo isset($value['rating_count']) ? $value['rating_count'] : 0; ?> lượt bình chọn</span>
                                    <span class="movie__rating"><?php echo isset($value['rating_count']) && $value['rating_count'] > 0 ? number_format($value['avg_rating'], 1) : 'Chưa có đánh giá'; ?></span>
                                </div>
