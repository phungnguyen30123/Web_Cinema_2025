...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 04, 2026 lúc 03:24 PM
...
(10, 45, 255, '110 000 đ', 0, ' A9, A8'),
(11, 45, 255, '110 000 đ', 0, ' A11, A10'),
(12, 45, 255, '110 000 đ', 0, ' A6, A5');
...
(254, 14, '2026-01-04', 1, '20:10', 60000),
(255, 14, '2025-12-27', 1, '17:30', 60000),
...
(269, 14, '2025-12-28', 1, '18:30', 60000),
...
--
-- Cấu trúc bảng cho bảng `comment_sentiment`
--
...
--
-- Đang đổ dữ liệu cho bảng `comment_sentiment`
--
...
(3, 'MOMOBKUN20180529', '17668404582260', '1766840458', '110000', 'Thanh toán vé xem phim - AVATAR - DÒNG CHẢY CỦA NƯ', 'momo_wallet', '4637013056', 'napas', '151e8988d0afdeca5f163faaa818a42b0ad908619aa2f82839');
...
(13, 'TẤM VÉ ĐẾN THIÊN ĐƯỜNG', '105 phút', 'Ol Parker', 'George Clooney, Julia Roberts, Kaitlyn Dever, Maxime Bouttier', 'Phụ đề Tiếng Việt', NULL, 'Hai diễn viên kỳ cựu của Hollywood - George Clooney và Julia Roberts sẽ tái hợp trên màn ảnh rộng trong vai đôi vợ chồng đã li hôn, nhưng lại cùng chung sứ mệnh ngăn cản cuộc kết hôn của đứa con gái yêu. Bởi họ sợ rằng con gái đang mắc phải sai lầm tương tự điều mà họ đã từng trải qua. Ticket to Paradise là một bộ phim hài lãng mạn về sự ngọt ngào bất ngờ của \"cơ hội thứ hai”.', '2026-12-01', 'Hài Hước', 'https://res.cloudinary.com/dv4syzarc/image/upload/v1766839587/web_cinema/movies/13/rilps3upzyyksolcwxes.jpg', 'https://res.cloudinary.com/dv4syzarc/image/upload/v1766839589/web_cinema/movies/13/w34rf5qqjpacels9vffp.jpg', 'https://res.cloudinary.com/dv4syzarc/image/upload/v1766839592/web_cinema/movies/13/bmrejffjeuwb8crkg5tu.jpg', 'https://res.cloudinary.com/dv4syzarc/image/upload/v1766839594/web_cinema/movies/13/rawmm5nasoiu0w7rt132.jpg', 'https://res.cloudinary.com/dv4syzarc/image/upload/v1766839595/web_cinema/movies/13/tkwtjlj06f4vputr80xr.jpg', 'https://res.cloudinary.com/dv4syzarc/image/upload/v1766839718/web_cinema/movies/13/jlivj5olrndimw3uolpc.jpg', 'https://res.cloudinary.com/dv4syzarc/image/upload/v1766839719/web_cinema/movies/13/zwefjto3f5oisi8pjr0b.jpg', ' https://www.youtube.com/watch?v=g8ona3jTuys    ', ' https://www.youtube.com/watch?v=g8ona3jTuys    '),
...
(7, '11000000', 'NCB', 'VNP15371665', 'ATM', 'Noi dung thanh toan', '20251227195905', '00', '0Y2DZ2YT', '15371665', '00', '7316', '94aee72e65cd5308e8f80e3e66647b0c6e965180f8414754843388ad324850ee916717ef1ed573d2d6ece00c5538be4b82d02312bc7ae35dbda44cd8dd757e22'),
(8, '11000000', 'NCB', 'VNP15371692', 'ATM', 'Noi dung thanh toan', '20251227211315', '00', '0Y2DZ2YT', '15371692', '00', '1820', 'e61eaa4bf3069e6242ca2122b8b30e61be0adf64afbc723c9aa5a3063f8ad8f76442cec3982822b45a3ee68069266408e2eb0dbbca9c0db6964e1b548b8b644e'),
(9, '11000000', 'NCB', 'VNP15371692', 'ATM', 'Noi dung thanh toan', '20251227211315', '00', '0Y2DZ2YT', '15371692', '00', '1820', 'e61eaa4bf3069e6242ca2122b8b30e61be0adf64afbc723c9aa5a3063f8ad8f76442cec3982822b45a3ee68069266408e2eb0dbbca9c0db6964e1b548b8b644e');
...
--
-- Chỉ mục cho bảng `comment_sentiment`
--
...
--
ALTER TABLE `booking`
  MODIFY `id_ve` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- AUTO_INCREMENT cho bảng `comment_sentiment`
--
ALTER TABLE `comment_sentiment`
...
--
-- Các ràng buộc cho bảng `comment_sentiment`
--
ALTER TABLE `comment_sentiment`
